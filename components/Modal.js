      ...
      <Transition show={isOpen} as={Fragment}>
        <Dialog as="div" className="fixed inset-0 z-50" onClose={setIsOpen}>
          <div className="flex items-start justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 text-center sm:block sm:p-0">
            ...
            >
              <div className="inline-block align-bottom sm:w-full sm:max-w-xl  sm:my-8 overflow-hidden text-left sm:align-middle transition-all transform bg-black shadow-xl rounded-2xl">
                    ...
                    <div className="mt-7 flex space-x-3 w-full">
                      ...
                      <div className="flex-grow mt-2">
                        <textarea
                          ...
                          rows="2"
                          className="bg-transparent outline-none text-lg text-[#d9d9d9] placeholder-gray-500 w-full tracking-wide min-h-[80px]"
                        ></textarea>
